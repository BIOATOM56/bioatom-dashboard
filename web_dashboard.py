...
MONITOR_FRUITS = [
    {"name": "Kitsune", "icon": "https://static.wikia.nocookie.net/bloxfruits/images/1/1d/KitsuneFruit.png"},
    {"name": "Dragon", "icon": "https://static.wikia.nocookie.net/bloxfruits/images/6/64/DragonFruit.png"},
    {"name": "Yeti", "icon": "https://static.wikia.nocookie.net/bloxfruits/images/0/07/YetiFruit.png"},
    {"name": "Tiger", "icon": "https://static.wikia.nocookie.net/bloxfruits/images/4/4b/LeopardFruit.png"},
    {"name": "Spirit", "icon": "https://static.wikia.nocookie.net/bloxfruits/images/7/70/SpiritFruit.png"},
    {"name": "Control", "icon": "https://static.wikia.nocookie.net/bloxfruits/images/8/87/ControlFruit.png"},
    {"name": "Gas", "icon": "https://static.wikia.nocookie.net/bloxfruits/images/2/2f/GasFruit.png"},
    {"name": "Venom", "icon": "https://static.wikia.nocookie.net/bloxfruits/images/4/49/VenomFruit.png"},
    {"name": "Shadow", "icon": "https://static.wikia.nocookie.net/bloxfruits/images/c/c5/ShadowFruit.png"},
    {"name": "Dough", "icon": "https://static.wikia.nocookie.net/bloxfruits/images/4/4f/DoughFruit.png"},
    {"name": "T-Rex", "icon": "https://static.wikia.nocookie.net/bloxfruits/images/e/e0/T-RexFruit.png"},
    {"name": "Mammoth", "icon": "https://static.wikia.nocookie.net/bloxfruits/images/9/91/MammothFruit.png"},
    {"name": "Gravity", "icon": "https://static.wikia.nocookie.net/bloxfruits/images/5/53/GravityFruit.png"},
    {"name": "Pain", "icon": "https://static.wikia.nocookie.net/bloxfruits/images/d/df/PainFruit.png"},
    {"name": "Portal", "icon": "https://static.wikia.nocookie.net/bloxfruits/images/e/e2/PortalFruit.png"},
    {"name": "Buddha", "icon": "https://static.wikia.nocookie.net/bloxfruits/images/5/5e/BuddhaFruit.png"},
    {"name": "Blizzard", "icon": "https://static.wikia.nocookie.net/bloxfruits/images/a/a2/BlizzardFruit.png"},
...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; font-family: 'Kanit', sans-serif; }
        ...
        .fruit-icon { width: 44px; height: 44px; object-fit: contain; }
            ...
            try {
                ...
                grid.innerHTML = data.fruits.map(f => `
                    <div class="fruit-card ${f.count > 0 ? 'active' : ''}">
                        <img class="fruit-icon" src="${f.icon}" onerror="this.src='https://placehold.co/44x44/1a1d26/ffffff?text=?'">
